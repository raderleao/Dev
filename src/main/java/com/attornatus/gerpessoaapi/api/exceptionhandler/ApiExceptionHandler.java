package com.attornatus.gerpessoaapi.api.exceptionhandler;

import com.attornatus.gerpessoaapi.domain.exception.EntidadeEmUsoException;
import com.attornatus.gerpessoaapi.domain.exception.EntidadeNaoEncontradaException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
        ...
        ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
        String detail = String.format("A propriedade '%s' não existe ou não está disponível para definir valor. "
